          ...
          <DialogContent className="max-md:max-h-screen max-md:overflow-y-auto">
            ...
            <div className="flex justify-around max-md:gap-2">
              <div className="w-1/2 max-md:w-full max-md:items-center flex flex-col">
                {preview ? (
                  <img src={preview} className="w-full h-full mb-2 mx-auto" />
                ) : (
                  <div
              ...
              <div>
                ...
                <div className="flex flex-col mt-2 gap-2">
                  ...
                  <Select onValueChange={(value) => setData("status", value)}>
                    ...
                    >
                      <SelectGroup>
                        ...
                        <SelectItem value="came_out">Вышел</SelectItem>
                        <SelectItem value="preview">Анонс</SelectItem>
                      </SelectGroup>
                    </SelectContent>
                  </Select>
                  <Input
                  ...
                  <Input
                    ...
                    className={` ${errors.studio ? "border-red-500" : ""}`}
                  />
                  <Select onValueChange={(value) => setData("age", value)}>
                    <SelectTrigger
